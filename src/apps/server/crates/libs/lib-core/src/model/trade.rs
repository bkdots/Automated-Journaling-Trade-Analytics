...
pub struct Trade {
    ...
    pub target_stop_loss: Option<f64>,
    pub target_takte_profit: Option<f64>,
    ...
    pub entry_rating: Option<i64>,
    pub exit_rating: Option<i64>,
    pub execution_rating: Option<i64>,
    pub management_rating: Option<i64>,
    pub net_profit_lose: Option<f64>,
    pub gross_profit_lose: Option<f64>,
    pub pnl_percentage: Option<f64>,
    #[serde_as(as = "Rfc3339")]
    pub time_in_trade: OffsetDateTime,
...
pub struct TradeFilter {
    ...
    pub direction_type: Option<OpValsString>,
    ...
    pub target_takte_profit: Option<OpValsValue>,
    ...
    pub net_profit_lose: Option<OpValsValue>,
    pub gross_profit_lose: Option<OpValsValue>,
